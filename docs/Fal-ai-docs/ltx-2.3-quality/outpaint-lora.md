...
- **Endpoint**: `https://fal.run/fal-ai/ltx-2.3-quality/outpaint/lora`
- **Model ID**: `fal-ai/ltx-2.3-quality/outpaint/lora`
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/ltx-2.3-quality/outpaint/lora \
...
const result = await fal.subscribe("fal-ai/ltx-2.3-quality/outpaint/lora", {
  input: {
    prompt: "A cinematic wide shot of the same scene, extending the environment naturally beyond the original frame.",
    video_url: "",
    loras: [{
...
- [Model Playground](https://fal.ai/models/fal-ai/ltx-2.3-quality/outpaint/lora)
- [API Documentation](https://fal.ai/models/fal-ai/ltx-2.3-quality/outpaint/lora/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/ltx-2.3-quality/outpaint/lora)
